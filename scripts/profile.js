...
// ฟังก์ชัน ajax ที่คุณมีอยู่แล้ว
...
//   let config = {
//     url: 'http://localhost:4000/api/products/get-for-edit',
//     method: 'GET'
//   }
...
//   // แสดง container และซ่อนข้อความ "ไม่มีสินค้า"
//   container.classList.remove('d-none');
//   document.getElementById('no-products-message').classList.add('d-none');

//   // แนบ Event Listener ให้กับปุ่ม Delete หลังจากที่ Element ถูกสร้างขึ้นมาแล้ว
...
//       // ถ้า Login แล้ว ดึงข้อมูลผู้ใช้มาแสดง
